...
-- Organizations: owner has full access, members can read
...
-- Competitions: public read, org admin write
...
-- Teams: public read, org admin write
...
-- Players: public read, team manager or org admin write
...
-- Matches: public read, org admin write
...
-- Match Events: public read, referee or admin write
...
-- Standings: public read, system managed
CREATE POLICY "standings_select" ON standings FOR SELECT USING (true);

-- Invites: org admin can manage, recipients can view their own
