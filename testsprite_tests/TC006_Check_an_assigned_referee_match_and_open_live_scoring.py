...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign In' link (interactive element index 540) to open the login page and reveal the email/password input fields.
        # link "Sign In"
        elem = page.locator("xpath=/html/body/div[2]/nav/div/div/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Create todo.md with the test plan, then fill the email and password fields and click the Sign In button to submit the login form.
        ...
        # -> Click the '▶ Start Match' button (interactive index 1456) to enter the live scoring workspace and then wait for the UI to update to verify the workspace appears.
        # button "▶ Start Match"
