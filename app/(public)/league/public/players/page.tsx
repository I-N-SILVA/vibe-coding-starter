            ...
            {isLoading ? (
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div
                            key={i}
                            className="animate-pulse rounded-xl bg-white p-8 shadow-sm dark:bg-white/5"
                        >
                            <div className="flex flex-col items-center">
                                <div className="mb-4 h-14 w-14 rounded-full bg-gray-100 dark:bg-white/10" />
                                <div className="mb-2 h-4 w-28 rounded bg-gray-100 dark:bg-white/10" />
