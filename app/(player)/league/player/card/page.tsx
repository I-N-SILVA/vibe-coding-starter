...
import { MOCK_PLAYER_PROFILE as MOCK_PLAYER } from '@/lib/mock/fixtures';
...
export default function PlayerCardPage() {
    ...
    const handleShareCard = async () => {
        ...
        const shareUrl = `${appUrl}/league/public/players/${player.id}`;
        try {
        ...
        <PageLayout title="MY CARD">
            <div className="mx-auto max-w-md pb-24">
                ...
                >
                    ...
                    <div className="grid grid-cols-4 gap-3">
                        {[
                            ...
                            {
                                label: 'Minutes',
                                value: player.seasonStats.minutesPlayed,
                                emoji: '⏱️',
                            },
                ...
                <div className="mt-8 flex gap-3">
                    <Button
                        fullWidth
                        className={`h-14 rounded-2xl transition-colors ${copied ? 'bg-green-600 text-white' : 'bg-black text-white'}`}
                        onClick={handleShareCard}
                    >
                        {copied ? (
                            <>
                                <Check className="mr-2 h-4 w-4" /> Link copied! Share your card
                            </>
                        ) : (
                            <>
                    ...
                    <Button variant="secondary" className="h-14 rounded-2xl border-gray-200 px-6">
