...
export default function PlayerDashboard() {
    ...
    // Mock data for player experience
    const playerStats = {
        goals: 14,
        assists: 8,
        appearances: 12,
    ...
    const nextMatch = {
        ...
        awayTeam: { name: 'Plyaz Stars', shortName: 'PLY' },
            ...
            >
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="flex-1 text-center">
                                    <p className="text-lg font-bold text-gray-900">{nextMatch.homeTeam.name}</p>
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{nextMatch.homeTeam.shortName}</p>
                                </div>
                                ...
                                <div className="flex-1 text-center">
                                    <p className="text-lg font-bold text-gray-900">{nextMatch.awayTeam.name}</p>
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{nextMatch.awayTeam.shortName}</p>
                                </div>
                            </div>
                ...
                <motion.section variants={fadeUp} id="team">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <Badge variant="secondary">22 Members</Badge>
                    </div>
                    <div className="space-y-3">
                        {[
                            { name: 'David Chen', pos: 'GK', num: 1 },
                            { name: 'Ryan Williams', pos: 'CB', num: 4 },
                            { name: 'James Obi', pos: 'CM', num: 8 },
                        ].map((teammate, i) => (
                                ...
                                <CardContent className="p-4 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">{teammate.pos}</p>
                                        </div>
                                    </div>
