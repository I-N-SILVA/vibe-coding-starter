  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        body: ['General Sans', ...fontFamily.sans],
        display: ['var(--font-space-display)', ...fontFamily.serif],
        serif: ['Playfair Display', ...fontFamily.serif],
      },
      colors: {
        primary: {
          lighter: customColors.primary.lighter,
          light: customColors.primary.light,
          main: customColors.primary.main,
          dark: customColors.primary.dark,
          darker: customColors.primary.darker,
        ...
        accent: {
          lighter: customColors.accent.lighter,
          light: customColors.accent.light,
          main: customColors.accent.main,
          dark: customColors.accent.dark,
          darker: customColors.accent.darker,
          DEFAULT: customColors.accent.main,
          foreground: '#FFFFFF',
        },
        surface: {
          main: customColors.surface.main,
          elevated: customColors.surface.elevated,
          glass: customColors.surface.glass,
        },
        popover: {
