...
export const createClient = () => {
    // Trim to defend against a trailing newline/whitespace in the env var,
    // which would otherwise be URL-encoded (%0A) into the realtime WS apikey and break the connection.
